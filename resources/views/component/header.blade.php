<header class="bg-eerieblack fixed w-full z-50">
                ...
                <div class="relative group">
                    ...
                    <div
                        ...
                        <div class="py-2 px-4">
                            ...
                            <a href="/profil#lab-types" class="block text-silver text-sm py-2 hover:text-yellow">Jenis
                                Lab</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div class="py-2 px-4">
                            <a href="/permohonan" class="block text-silver text-sm py-2 hover:text-yellow">Permohonan
                                Penelitian</a>
                            <a href="/booking-Eksternal" class="block text-silver text-sm py-2 hover:text-yellow">Book
                                Lab Eksternal</a>
    ...
    <div class="hidden md:hidden bg-eerieblack w-full border-t border-gray-700 shadow-lg" id="mobile-menu">
        ...
        <div class="mobile-dropdown">
            <div class="w-full text-silver flex justify-between items-center px-4 py-3 hover:bg-gray-800 transition-colors"
