    ...
    <section class="bg-eerieblack text-silver py-32 relative overflow-hidden px-10">
        <div class="container mx-auto py-5">
            <div class="text-center relative z-10">
                ...
                <p class="text-lg mb-8 opacity-90 max-w-3xl mx-auto">Mengenal lebih dekat tentang visi, misi, dan struktur
                    organisasi Laboratorium Teknik Sipil Universitas Muhammadiyah Surakarta.</p>
            </div>
        </div>
    ...
    <section class="bg-gradient-to-b from-white to-gray-50 py-24" id="vision-mission">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-night max-w-2xl mx-auto">Komitmen kami dalam mengembangkan pendidikan dan penelitian di
                    bidang Teknik Sipil</p>
            </div>
                    ...
                    <div class="bg-davysgray rounded-xl p-8 shadow-lg h-full border-t-4 border-yellow">
                        <div class="flex items-center mb-6">
                            <div class="w-12 h-12 bg-yellow rounded-full flex items-center justify-center mr-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-eerieblack" fill="none"
                        ...
                        <p class="text-night text-lg leading-relaxed">Mengembangkan ilmu pengetahuan dan teknologi untuk
                            merancang, membangun, dan mengelola infrastruktur sipil yang inovatif dan berkelanjutan
                            berdasarkan nilai keislaman.</p>
                    </div>
                </div>
                    ...
                    <div class="bg-davysgray rounded-xl p-8 shadow-lg h-full border-t-4 border-yellow">
                        ...
                        <ul class="space-y-6">
                            <li class="flex items-start group">
                                <div
                                    class="w-6 h-6 bg-yellow rounded-full flex-shrink-0 flex items-center justify-center mr-4 mt-1 group-hover:scale-110 transition-transform duration-300">
                                    <span class="text-eerieblack font-bold text-sm">1</span>
                                </div>
                                <p class="text-night">Menyelenggarakan pendidikan bidang teknik sipil dalam lingkungan
                                    Islami dengan keunggulan dalam pelaksanaan dan perancangan serta menekankan pembentukan
                                    karakter Islami, tangguh, dan mampu bekerja secara tim.</p>
                            </li>
                            <li class="flex items-start group">
                                <div
                                    class="w-6 h-6 bg-yellow rounded-full flex-shrink-0 flex items-center justify-center mr-4 mt-1 group-hover:scale-110 transition-transform duration-300">
                                ...
                                <p class="text-night">Mengembangkan penelitian yang inovatif di bidang teknik sipil dengan
                                    mengedepankan keunggulan di bidang konservasi sumberdaya alam (reuse, reduce, recycle).
                                </p>
                            </li>
                            <li class="flex items-start group">
                                <div
                                ...
                                <p class="text-night">Mengembangkan pengabdian kepada masyarakat dalam pemecahan
                                    permasalahan di bidang teknik sipil guna mendorong sinergi antara program studi dengan
                                    institusi luar.</p>
                            </li>
                        </ul>
                    </div>
    ...
    <section class="bg-gradient-to-b from-white to-gray-50 py-20" id="structure">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16 text-night">
                ...
                <p class="text-night max-w-2xl mx-auto">Struktur organisasi laboratorium yang terorganisir dengan baik untuk
                    mendukung kegiatan pembelajaran, penelitian dan pengabdian masyarakat.</p>
            </div>

            <div class="bg-davysgray rounded-lg p-8 shadow-lg mb-12 max-w-5xl mx-auto">
                <img src="{{ asset('image/struktur-organisasi.jpeg') }}" alt="Struktur Organisasi"
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                    <div class="w-20 h-20 bg-yellow/20 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-yellow" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                    ...
                    <p class="text-night">Mengelola operasional harian, peralatan, dan membantu kegiatan praktikum
                        mahasiswa.</p>
                </div>
            </div>
        </div>
    ...
    <section class="bg-white py-20" id="lab-types">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16 text-night">
                ...
                <p class="text-night max-w-2xl mx-auto">Laboratorium Teknik Sipil UMS memiliki berbagai laboratorium yang
                    lengkap untuk mendukung kegiatan akademik dan penelitian.</p>
            </div>

            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div class="aspect-[4/5] overflow-hidden">
                        <img src="{{ asset('image/lab-bahan.jpg') }}" alt="Lab Teknologi Bahan"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 text-center">
                        <h3 class="text-xl font-bold mb-2">Lab Tek. Bahan</h3>
                        <p class="text-night">pengujian Kekuatan Tekan Beton, Pengujian Kuat Lentur, Pengujian Tarik Baja
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div class="aspect-[4/5] overflow-hidden">
                        <img src="{{ asset('image/lab-pekerasan.jpg') }}" alt="Lab Bahan Pekerasan"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 text-center">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div class="aspect-[4/5] overflow-hidden">
                        <img src="{{ asset('image/lab-geomatika.jpg') }}" alt="Lab Geomatika"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 text-center">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div class="aspect-[4/5] overflow-hidden">
                        <img src="{{ asset('image/lab-tanah.jpg') }}" alt="Lab Mekanika Tanah"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 text-center">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div class="aspect-[4/5] overflow-hidden">
                        <img src="{{ asset('image/lab-jalan.jpg') }}" alt="Lab Jalan Raya"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 text-center">
