    ...
    <section class="bg-eerieblack text-silver py-20 relative overflow-hidden px-10">
        <div class="container mx-auto my-8 py-5">
            <div class="text-center relative z-10">
                <h1 class="text-5xl font-bold mb-6">Informasi <span class="text-yellow">Laboratorium</span> Teknik Sipil UMS
                </h1>
                <p class="text-lg mb-8 opacity-90 max-w-3xl mx-auto">Temukan informasi kontak, tata tertib, prosedur
                    operasional standar, dan informasi keselamatan untuk penggunaan fasilitas laboratorium teknik sipil.</p>
                <div class="flex justify-center gap-4">
                    <a href="#kontak"
                        class="bg-yellow text-eerieblack px-6 py-2 rounded-md font-semibold uppercase text-sm hover:bg-yellow-500 hover:shadow-lg transition-all">Informasi
                        Kontak</a>
                    <a href="#tata-tertib"
                        class="bg-transparent border border-yellow text-yellow px-6 py-2 rounded-md font-semibold uppercase text-sm hover:bg-yellow/10 hover:shadow-lg transition-all">Tata
                        Tertib Lab</a>
                </div>
            </div>
        </div>
    ...
    <section class="bg-gradient-to-b from-white to-gray-50 py-16" id="kontak">
        <div class="container mx-auto py-16" id="kontak-hotline">
            <div class="text-center mb-16">
                ...
                <p class="text-night max-w-2xl mx-auto">Kontak cepat untuk layanan darurat dan informasi laboratorium teknik
                    sipil UMS.</p>
            </div>
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-center justify-between border-b border-silver/20 pb-4">
                                <div class="flex items-center">
                                    <div
                                        class="bg-yellow text-night w-10 h-10 rounded-full flex items-center justify-center mr-4">
                    ...
                    <div class="p-6">
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-center justify-between border-b border-silver/20 pb-4">
                                <div class="flex items-center">
                                    <div
                                        class="bg-yellow text-eerieblack w-10 h-10 rounded-full flex items-center justify-center mr-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            ...
            <div class="mt-12 bg-eerieblack rounded-lg p-6 max-w-3xl mx-auto shadow-lg border-l-4 border-yellow">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-eerieblack mr-4 flex-shrink-0"
    ...
    <section class="bg-gradient-to-b from-white to-gray-50 text-night py-16" id="tata-tertib">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="max-w-2xl mx-auto">Tata tertib ini disusun untuk memastikan keamanan, kenyamanan, dan efektivitas
                    penggunaan laboratorium bagi seluruh pengguna.</p>
            </div>
                ...
                <div class="bg-eerieblack rounded-lg p-8 shadow-lg">
                    ...
                    <ul class="space-y-4 text-white">
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
                                1</div>
                            <p>Wajib menggunakan alat-alat praktikum sesuai dengan prosedur yang benar dan mematuhi petunjuk
                                umum Keschatan dan Keselamatan Kerja (K3).</p>
                        </li>
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
                                2</div>
                            <p>Wajib berpakaian sopan, rapi dan bersepatu tertutup, sarung tangan dan masker jika
                                diperlukan.</p>
                        </li>
                        <li class="flex items-start">
                            <div
                        ...
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
                                6</div>
                            <p>Menjunjung tinggi dan menghargai pembimbing, laboran dan asisten laboratorium dan sesama
                                pengguna laboratorium.</p>
                        </li>
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
                                7</div>
                            <p>Membersihkan peralatan yang digunakan dalam praktikum maupun penelitian dan mengembalikannya
                                kepada petugas laboratorium (laboran).</p>
                        </li>
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
                                8</div>
                            <p>Membaca, memahami dan mengikuti prosedur operasional untuk setiap peralatan dan kegiatan
                                selama praktikum dan di ruang laboratorium.</p>
                        </li>
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
                        ...
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
                                10</div>
                            <p>Wajib memelihara alat-alat praktikum apabila didapati merusak/memecahkan alat praktikum maka
                                wajib untuk mengganti.</p>
                        </li>
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
                        ...
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
                                12</div>
                            <p>Bagi Mahasiswa Tugas Akhir yang melakukan penelitian dilaboratorium harap konfirmasi dan
                                mendaflar dahulu ke laboran.</p>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="space-y-4 text-white">
                        ...
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
                                4</div>
                            <p>Dilarang menyentuh, menggeser dan menggunakan peralatan di laboratorium yang tidak sesuai
                                dengan acara praktikum matakuliah yang diambil.</p>
                        </li>
                        <li class="flex items-start">
                            <div
                                class="bg-yellow text-eerieblack w-6 h-6 rounded-full flex items-center justify-center font-bold mr-4 mt-1">
    ...
    <section class="bg-gradient-to-b from-white to-gray-50 py-20" id="sop">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-night max-w-2xl mx-auto">Berikut adalah prosedur standar yang berlaku untuk penggunaan
                    laboratorium Teknik Sipil UMS.</p>
            </div>

            <div class="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                <!-- SOP Card 1 -->
                <div
                    class="bg-white border border-silver/30 rounded-lg overflow-hidden shadow-lg transform hover:-translate-y-2 transition duration-300">
                    <div class="h-16 bg-yellow flex items-center px-6">
                        <h3 class="text-xl text-eerieblack font-bold">SOP Peminjaman Alat dan Bahan Praktikum Untuk
                            Mahasiswa</h3>
                    </div>
                    <div class="p-6">
                ...
                <!-- SOP Card 3 -->
                <div
                    class="bg-white border border-silver/30 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                    <div class="h-16 bg-yellow flex items-center px-6">
                        <h3 class="text-xl text-eerieblack font-bold">SOP Peminjaman Alat dan Bahan untuk Pihak Luar</h3>
                    </div>
                    <div class="p-6">
                        <ol class="list-decimal pl-5 space-y-3 text-night">
                            <li>Pihak luar membawa surat permohonan pengajuan penggunaan laboratorium kepada Kepala
                                Laboratorium.</li>
                            <li>Pihak luar mengajukan permohonan peminjaman alat dan penggunaan bahan kepada Kepala
                                Laboratorium.</li>
                            <li>Kepala Laboratorium menerima permohonan peminjaman alat dan penggunaan bahan dari pihak
                                luar.</li>
                            <li>Kepala Laboratorium mengkoordinasikan permohonan peminjaman alat dan kebutuhan bahan kepada
                                laboran.</li>
                            <li>Laboran memeriksa kondisi alat dan bahan sesuai permohonan peminjaman alat dan bahan yang
                                diajukan pihak luar. Jika ada alat yang tidak sesuai maka laboran akan menginformasikan
                                kepada pihak luar. Jika alat sesuai dengan yang dibutuhkan/tidak sedang digunakan maka boleh
                                dipinjamkan.</li>
                            <li>Laboran menyiapkan alat dan bahan sesuai dengan permohonan peminjaman alat dan kebutuhan
                                bahan.</li>
                            ...
                            <li>Pihak luar memeriksa alat dan bahan yang diterima. Jika tidak sesuai maka pihak luar akan
                                melaporkan kepada laboran. Jika sudah sesuai, maka alat dan bahan dapat dibawa.</li>
                            <li>Pihak luar mengembalikan alat sesuai jangka waktu yang ditentukan.</li>
                            <li>Laboran memeriksa kembali alat yang dipinjam. Jika kondisinya baik, maka diterima. Jika
                                kondisinya rusak (pecah, dll) atau hilang, maka pihak luar harus mengganti alat tersebut
                                dengan spesifikasi yang sama.</li>
                ...
                <div
                    class="bg-white border border-silver/30 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                    <div class="h-16 bg-yellow flex items-center px-6">
                        <h3 class="text-xl text-eerieblack font-bold">SOP Pelaksanaan Kegiatan Praktikum di Laboratorium
                        </h3>
                    </div>
                    <div class="p-6">
                        <ol class="list-decimal pl-5 space-y-3 text-night">
                            <li>Dosen pembimbing/pengampu praktikum melakukan koordinasi dengan laboran dan asisten
                                praktikum terkait waktu pelaksanaan, kebutuhan dan fasilitas untuk kegiatan praktikum.</li>
                            ...
                            <li>Mahasiswa praktikum mendaftar kegiatan praktikum sesuai dengan mata kuliah yang diambil
                                didampingi asisten.</li>
                            ...
                            <li>Bagi yang tidak mengikuti praktikum selama masa praktikum, wajib mengulangi di semester
                                berikutnya.</li>
                            <li>Setelah kegiatan praktikum selesai, mahasiswa (praktikan) membersihkan peralatan dan sisa
                                bahan yang digunakan dan mengembalikan peralatan kepada asisten.</li>
                            <li>Asisten praktikum melakukan cek atas peralatan yang dipinjam dan sisa bahan yang digunakan
                                dalam kegiatan praktikum, untuk memastikan kondisinya sama dengan saat peralatan akan
                                dipinjam. Jika kondisi alat rusak/hilang maka mahasiswa (praktikan) harus mengganti dengan
    ...
    <section class="bg-gradient-to-b from-white to-gray-50 py-16" id="kebijakan-k3">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="max-w-2xl mx-auto text-night">Kebijakan keselamatan yang berlaku untuk seluruh pengguna
                    laboratorium Teknik Sipil UMS.</p>
            </div>
            ...
            <div class="bg-eerieblack rounded-lg p-8 shadow-lg max-w-5xl mx-auto mb-12">
                ...
                <ul class="space-y-6 text-white">
                    <li class="flex items-start">
                        <div
                            class="bg-yellow text-eerieblack min-w-[28px] h-7 rounded-full flex items-center justify-center font-bold mr-4">
                            1</div>
                        <p class="pt-1">Mengutamakan keselamatan dosen, mahasiswa, karyawan, dan pengunjung dari pengguna
                            di Laboratorium Teknik Sipil.</p>
                    </li>
                    <li class="flex items-start">
                        <div
                            class="bg-yellow text-eerieblack min-w-[28px] h-7 rounded-full flex items-center justify-center font-bold mr-4">
                            2</div>
                        <p class="pt-1">Menjamin semua dosen, mahasiswa, dan karyawan mengetahui dan melaksanakan
                            pekerjaan secara produktif dengan cara yang aman melalui petunjuk yang benar, instruksi
                            pekerjaan yang tepat, instruksi pemakaian peralatan yang tepat dan pengawasan yang tepat.</p>
                    </li>
                    <li class="flex items-start">
                        <div
                            class="bg-yellow text-eerieblack min-w-[28px] h-7 rounded-full flex items-center justify-center font-bold mr-4">
                            3</div>
                        <p class="pt-1">Menyediakan fasilitas, peralatan, perlengkapan keselamatan kerja yang layak dan
                            memadai serta menjamin penggunaan secara tepat.</p>
                    </li>
                    <li class="flex items-start">
                        <div
                            class="bg-yellow text-eerieblack min-w-[28px] h-7 rounded-full flex items-center justify-center font-bold mr-4">
                            4</div>
                        <p class="pt-1">Memastikan bahwa kebijakan K3 yang diminta dan direkomendasikan telah dipatuhi.
                        </p>
                    </li>
                    <li class="flex items-start">
                        <div
                            class="bg-yellow text-eerieblack min-w-[28px] h-7 rounded-full flex items-center justify-center font-bold mr-4">
                            5</div>
                        <p class="pt-1">Meningkatkan kesadaran dan memberikan pengertian bahwa kecelakan dapat dicegah.
                        </p>
                    </li>
                    <li class="flex items-start">
                        <div
                            class="bg-yellow text-eerieblack min-w-[28px] h-7 rounded-full flex items-center justify-center font-bold mr-4">
                            6</div>
                        <p class="pt-1">Memberikan pengertian bahwa target utama K3 Lab Teknik Sipil FT UMS adalah "zero
                            accident".</p>
                    </li>
                    <li class="flex items-start">
                        <div
                            class="bg-yellow text-eerieblack min-w-[28px] h-7 rounded-full flex items-center justify-center font-bold mr-4">
                            7</div>
                        <p class="pt-1">Meningkatkan perlindungan dan pelestarian lingkungan dalam segala aktivitas dan
                            meminimalisir kerusakan yang mungkin terjadi.</p>
                    </li>
                </ul>
            </div>
    ...
    <section class="bg-gradient-to-b from-white to-gray-50 py-16" id="tanda-peringatan">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="max-w-2xl mx-auto text-night">Perhatikan tanda-tanda peringatan berikut untuk keselamatan
                    bersama.</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-8 mb-12 border-l-8 border-yellow max-w-5xl mx-auto">
                <h3 class="text-2xl font-bold mb-6 text-night flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mr-3 text-yellow" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="p-3 rounded border border-gray-300 bg-gray-50 text-center">
                            ...
                            <div class="h-16 flex items-center justify-center">
                                <img src="{{ asset('image/caution.svg') }}" alt="Caution sign"
                        ...
                        <div class="p-3 rounded border border-gray-300 bg-gray-50 text-center">
                            ...
                            <div class="h-16 flex items-center justify-center">
                                <img src="{{ asset('image/evakuasi.png') }}" alt="Caution sign"
                                    class="mx-auto w-full h-full object-contain" />
                            </div>
                        </div>
                        <div class="p-3 rounded border border-gray-300 bg-gray-50 text-center">
                            ...
                            <div class="h-16 flex items-center justify-center">
                                <img src="{{ asset('image/apar.png') }}" alt="Caution sign"
                                    class="mx-auto w-full h-full object-contain" />
                            </div>
                        </div>
                        <div class="p-3 rounded border border-gray-300 bg-gray-50 text-center">
                            ...
                            <div class="h-16 flex items-center justify-center">
                                <img src="{{ asset('image/voltage.png') }}" alt="Caution sign"
                                    class="mx-auto w-full h-full object-contain" />
                            </div>
                        </div>
                        <div class="p-3 rounded border border-gray-300 bg-gray-50 text-center">
                            ...
                            <div class="h-16 flex items-center justify-center">
                                <img src="{{ asset('image/licin.png') }}" alt="Caution sign"
                                    class="mx-auto w-full h-full object-contain" />
                            </div>
                        </div>
                        <div class="p-3 rounded border border-gray-300 bg-gray-50 text-center">
                            ...
                            <div class="h-16 flex items-center justify-center">
                                <img src="{{ asset('image/flame.png') }}" alt="Caution sign"
                                    class="mx-auto w-full h-full object-contain" />
                            </div>
                        </div>
                    </div>
    ...
    <section class="bg-gradient-to-b from-white to-gray-50 py-16" id="prosedur-darurat">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="max-w-2xl mx-auto text-night">Prosedur penanganan kecelakaan di laboratorium Teknik Sipil UMS.
                </p>
            </div>
            ...
            <div class="bg-davysgray rounded-xl shadow-lg p-8 max-w-5xl mx-auto border-l-4 border-yellow">
                <h3 class="text-2xl font-bold mb-6 text-yellow flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mr-3" fill="#FFD700" stroke="black"
                ...
                <ol class="space-y-4 text-night">
                    <li class="flex items-start">
                        <span
                            class="bg-yellow text-eerieblack font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1">1</span>
                        <p>Laporkan semua kecelakaan kepada laboran/coordinator laboratorium secepatnya.</p>
                    </li>
                    <li class="flex items-start">
                        <span
                            class="bg-yellow text-eerieblack font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1">2</span>
                        <p>Jangan panik.</p>
                    </li>
                    <li class="flex items-start">
                        <span
                            class="bg-yellow text-eerieblack font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1">3</span>
                        <p>Jika bahan-bahan kimia yang mengenai bagian tubuh, secepatnya cuci dengan air mengalir selama
                            minimal 20 menit.</p>
                    </li>
                    <li class="flex items-start">
                        <span
                            class="bg-yellow text-eerieblack font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1">4</span>
                        <p>Jika terjadi kebakaran, maka gunakan APAR yang berada pada sudut-sudut ruangan yang telah
                            disediakan APAR.</p>
                    </li>
                    <li class="flex items-start">
                        <span
                            class="bg-yellow text-eerieblack font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1">5</span>
                        <p>Jika terjadi luka,benturan,terkena benda keras. Segera lakukan pertolongan pertama membawa ke MMC
                            UMS.</p>
                    </li>
                </ol>
                ...
                <div class="mt-8 bg-eerieblack rounded-lg p-6 border-l-4 border-yellow">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-yellow mr-4 flex-shrink-0"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                        </svg>
                        <div>
                            <h4 class="text-lg font-bold text-yellow">Penting!</h4>
                            <p class="text-silver">Dalam keadaan darurat, hubungi langsung nomor kontak emergency yang
                                tersedia di halaman informasi kontak.</p>
                        </div>
                    </div>
                </div>
            </div>
