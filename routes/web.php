...
Route::get('/generate-bebas-lab/{id}', [PermohonanController::class, 'generateBebasLabPDF'])->name('generate.bebas.lab');
...
Route::get('/generate-word-document/{id}', [AggregatController::class, 'generatePermohonanBahanPDF'])->name('generate.word.document');
